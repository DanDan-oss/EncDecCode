...
static ::_pb::Metadata file_level_metadata_SocketMSG_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_SocketMSG_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_SocketMSG_2eproto = nullptr;

const uint32_t TableStruct_SocketMSG_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_SocketMSG_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017SocketMSG.proto\"]\n\nRequestMsg\022\017\n\007cmdTy"
  ...
  ;
static ::_pbi::once_flag descriptor_table_SocketMSG_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_SocketMSG_2eproto = {
    false, false, 214, descriptor_table_protodef_SocketMSG_2eproto,
    "SocketMSG.proto",
    &descriptor_table_SocketMSG_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_SocketMSG_2eproto::offsets,
    file_level_metadata_SocketMSG_2eproto, file_level_enum_descriptors_SocketMSG_2eproto,
    file_level_service_descriptors_SocketMSG_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_SocketMSG_2eproto_getter() {
  return &descriptor_table_SocketMSG_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_SocketMSG_2eproto(&descriptor_table_SocketMSG_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata RequestMsg::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_SocketMSG_2eproto_getter, &descriptor_table_SocketMSG_2eproto_once,
      file_level_metadata_SocketMSG_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata RespondMsg::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_SocketMSG_2eproto_getter, &descriptor_table_SocketMSG_2eproto_once,
      file_level_metadata_SocketMSG_2eproto[1]);
}
