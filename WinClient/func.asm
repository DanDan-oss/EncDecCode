includelib libcrypto.lib
.model flat, c

.data

BIO_new proto type:DWORD
BIO_f_base64 proto
BIO_s_mem proto
BIO_push proto b:dword, append:dword
BIO_write proto b:dword, intext:dword, sizestr:dword
...
call BIO_new
add esp, 0x4
mov dword ptr ds:[ebp+0x4], eax		; base64= BIO_new(BIO_f_base64()); 

call BIO_s_mem
push eax
call BIO_new
add esp, 0x4
mov dword ptr ds:[ebp+0x8], eax	; mem = BIO_new(BIO_s_mem());

mov eax, dword ptr ds:[ebp+8]
mov ecx, dword ptr ds:[ebp+4]
push eax
push ecx
call BIO_push
add esp+8		;BIO_push(base64, mem);
